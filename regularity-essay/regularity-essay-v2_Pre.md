...
- $m\le 6$: **no** — Simons [14] (building on De Giorgi and Fleming) proved that every stable minimal cone in $\mathbb R^{m+1}$ for $m\le 6$ is a plane. Hence $\operatorname{Sing}=\varnothing$ for $m\le 6$.
...
- *Moser (1961)* [9] gave the clean iteration proof and the Harnack inequality.
...
- The general $L^p$ result for the Laplacian on smooth domains was a long-standing open problem; the full *$L^p$ maximal regularity problem* (for arbitrary sectorial operators / Banach spaces) was solved by *Kalton–Weis [32]* using the $H^\infty$-functional calculus and $R$-boundedness.
...
5. H. Federer, *The singular sets of area minimizing rectifiable currents with codimension one and of area minimizing flat chains modulo two with arbitrary codimension*, Bull. Amer. Math. Soc. **76** (1969), 767–771.
...
7. E. De Giorgi, *Sulla continuità delle estremali di certi funzionali del calcolo delle variazioni*, Ann. Mat. Pura Appl. (4) **37** (1957), 244–268.
8. J. Nash, *Continuity of solutions of parabolic and elliptic equations*, Amer. J. Math. **80** (1958), 931–954.
9. J. Moser, *A new proof of De Giorgi's theorem concerning the regularity problem for elliptic partial differential equations*, Comm. Pure Appl. Math. **13** (1961), 457–468.
10. L. Caffarelli, L. Kohn, L. Nirenberg, *Partial regularity of suitable weak solutions of the Navier–Stokes equations*, Comm. Pure Appl. Math. **35** (1982), 771–851.
...
27. G. S. Weiss, *Monotonicity formulas for the obstacle problem and an application to the regularity of the free boundary*, Comm. Partial Differential Equations **27** (2002), 1585–1603.
...
32. N. J. Kalton, L. Weis, *A solution to the $L^p$ maximal regularity problem*, Math. Z. **235** (2000), 559–568.
...
37. L. Modica, S. Mortola, *Un esempio di $\Gamma$-convergenza*, Boll. Un. Mat. Ital. B (8) **14** (1997), 285–299.
